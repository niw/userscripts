...
try {
	...
	function jsonp(url, callback) {
		if(typeof window.jsonpc == "undefined") {
			window.jsonpc = + new Date();
		}
		if(typeof GM_xmlhttpRequest != "undefined") {
			...
			var jsonpf = "jsonp" + jsonpc++;
			script.setAttribute("src", url + (url.match(/\?/) ? "&" : "?") + "callback=" + jsonpf);
			window[jsonpf] = function(data) {
				script.parentNode.removeChild(script);
				window[jsonpf] = undefined;
				callback(data);
			};
